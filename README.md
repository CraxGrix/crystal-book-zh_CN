...
* [语法和语义](syntax_and_semantics/README.md)
   ...
   * [字面量 Literals](syntax_and_semantics/literals.md)
       ...
       * [正则表达式 Regex](syntax_and_semantics/literals/regex.md)
       * [元组 Tuple](syntax_and_semantics/literals/tuple.md)
       * [命名元组 NamedTuple](syntax_and_semantics/literals/named_tuple.md)
       * [指针 Proc](syntax_and_semantics/literals/proc.md)
       * [Shell 命令 Command](syntax_and_semantics/literals/command.md)
   * [赋值 Assignment](syntax_and_semantics/assignment.md)
   * [局部变量 Local variables](syntax_and_semantics/local_variables.md)
   * [控制表达式 Control expressions](syntax_and_semantics/control_expressions.md)
